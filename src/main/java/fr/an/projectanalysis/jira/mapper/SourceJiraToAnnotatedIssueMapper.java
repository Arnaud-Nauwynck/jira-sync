package fr.an.projectanalysis.jira.mapper;

import fr.an.projectanalysis.jira.client.dtos.SourceJiraIssueDTO;
import fr.an.projectanalysis.jira.rest.dtos.JiraIssueDTO;
import fr.an.projectanalysis.jira.rest.dtos.JiraIssueDTO.IssueCommentDTO;
import fr.an.projectanalysis.jira.rest.dtos.JiraIssueDTO.IssueFieldsDTO;
import fr.an.projectanalysis.jira.rest.dtos.JiraIssueDTO.IssueHistoryDTO;
import fr.an.projectanalysis.jira.rest.dtos.JiraIssueDTO.IssueHistoryItemDTO;
import fr.an.projectanalysis.jira.rest.dtos.JiraIssueDTO.IssueLinkDTO;
import fr.an.projectanalysis.jira.rest.dtos.JiraIssueDTO.IssueLinkTypeDTO;
import fr.an.projectanalysis.jira.rest.dtos.JiraIssueDTO.LinkedIssueDTO;
import fr.an.projectanalysis.jira.rest.dtos.JiraIssueDTO.AnnotatedJiraLinkedIssueFieldsDTO;
import fr.an.projectanalysis.jira.rest.dtos.JiraIssueDTO.IssueProgressDTO;
