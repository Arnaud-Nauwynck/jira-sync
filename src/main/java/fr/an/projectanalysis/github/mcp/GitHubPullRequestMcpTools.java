package fr.an.projectanalysis.github.mcp;
...
@Component
@Slf4j
public class GitHubPullRequestMcpTools {

    private final GitHubPullRequestService pullRequestService;
    private final GitHubPullRequestSyncRunner gitHubPrSyncRunner;

    public GitHubPullRequestMcpTools(GitHubPullRequestService pullRequestService, GitHubPullRequestSyncRunner gitHubPrSyncRunner) {
