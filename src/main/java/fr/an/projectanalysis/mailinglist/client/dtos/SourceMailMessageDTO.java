package fr.an.projectanalysis.mailinglist.client.dtos;
...
/**
 * Mirrors one parsed RFC 822 MIME message out of a monthly mbox archive downloaded from
 ...
 * for a sample), flattened to the fields worth keeping.
 * <p>
 ...
 * See {@code fr.an.jira.mailinglist.mapper.MimeMessageToSourceMailMessageMapper} for the parsing
 * from the MIME {@code Message}, and {@code fr.an.jira.mailinglist.mapper.SourceMailMessageToAnnotatedMailMessageMapper}
 * for the conversion to {@code fr.an.jira.mailinglist.rest.dtos.MailMessageDTO}.
 */
@Data
public class SourceMailMessageDTO {
